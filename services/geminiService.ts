...
export const generateCharacterImage = async (player: Player): Promise<string> => {
    try {
        const prompt = `16-bit, pixel art portrait of ${player.name}, a ${player.profession} from the 17th century. Fantasy RPG style, similar to classic SNES games. The character should look weary from travel but determined. Centered bust, plain background.`;
